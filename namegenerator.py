...
def main():
    """
    A fiunction thst genarate pseudonames.
    """
    ...
    first = ('Baby Oil', 'Bad News', 'Big Burps', "Bill 'Beenie­Weenie'",
        ...
        'Huggy', 'Ignatious', 'Jimbo', "Joe 'Pottin Soil'", 'Johnny', 'Lemongrass',
        ...
        "Sid 'The Squirts'",'Skidmark', 'Slaps', 'Snakes', 'Snoobs', 'Snorki',
    ...
    last = ('Appleyard', 'Bigmeat', 'Bloominshine', 'Boogerbottom', 'Breedslovetrout',
        ...
        'Olivetti', 'Outerbridge', 'Overpeck', 'Overturf', 'Oxhandler', 'Pealike', 'Pennywhistle',
        'Peterson', 'Pieplow', 'Pinkerton', 'Porkins', 'Putney', 'Quakenbush', 'Rainwater',
        'Rosenthal','Rubbins','Sackrider', 'Snuggleshine', 'Splern', 'Stevens', 'Stroganoff',
        'Sugar­Gold','Swackhamer', 'Tippins', 'Turnipseed', 'Vinaigrette', 'Walkingstick',
        'Wallbanger', 'Weewax','Weiners', 'Whipkey', 'Wigglesworth','Wimplesnatch',
    ...
    while True:
        ...
        try_again = input("Try again?(Press Enter else press n.)")
        if try_again == 'n':
            break
